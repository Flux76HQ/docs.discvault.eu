...
description: 'Οδηγίες ειδικά για την εργασία: Ρύθμιση: Μεταβλητές περιβάλλοντος: `/opt/discvault-next/.env` · `DISCVAULT_NEXT_IMAGE` · `DISCVAULT_NEXT_POSTGRES_DATA` · `chmod 0600` · `openssl rand -base64 48` · `RP_ORIGINS` · `LEGACY_AUTH_ENABLED`.'
