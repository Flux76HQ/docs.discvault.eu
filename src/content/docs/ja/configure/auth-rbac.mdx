---
title: '設定: 認証と RBAC'
description: 'タスク別の手順: 設定: 認証と RBAC: `/api/next/auth/status` · `/api/next/auth/rbac` · WebAuthn · `48 h` · iOS/iPadOS `16+` · Android `9+` · Argon2id · TOTP.'
